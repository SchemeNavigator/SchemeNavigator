...
export const AnalyzingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-xl w-full bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-2xl text-center space-y-8 relative overflow-hidden">
        {/* Ambient Top Ring Glow */}
        <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-64 h-64 bg-teal-200/40 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="space-y-3 text-left max-w-md mx-auto bg-slate-50 p-5 rounded-2xl border border-slate-200/80">
          {steps.map((step, idx) => {
