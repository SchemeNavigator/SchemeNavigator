  ...
  return (
    <header className="sticky top-0 z-40 w-full max-w-full bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 shadow-xs transition-colors duration-200">
      <div className="w-full max-w-7xl 2xl:max-w-[1440px] mx-auto px-3 sm:px-6 lg:px-4 xl:px-6 2xl:px-8">
        <div className="flex items-center justify-between h-18 sm:h-20 gap-2 xl:gap-4 min-w-0">
          {/* Brand Logo */}
          <div className="shrink-0 flex items-center">
            <CompassLogo size="sm" />
          </div>

          {/* Center Navigation Links - Clean, open, direct (No separate gray capsule!) */}
          <nav className="hidden lg:flex items-center gap-1 xl:gap-2">
            ...
            >
              {t('nav.exploreSchemes', undefined, 'Explore Schemes')}
            </NavLink>

            <a
              href="#how-it-works"
              onClick={handleHowItWorksClick}
              className="px-3.5 py-2 rounded-xl text-sm font-semibold whitespace-nowrap text-slate-600 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-900 transition-all cursor-pointer"
            >
              {t('nav.howItWorks')}
            </a>
            ...
            <NavLink
              ...
              to="/assistant"
              className={({ isActive }) =>
                `inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-bold whitespace-nowrap transition-all ${
                  isActive
            ...
            <NavLink
              ...
              to="/kendra-finder"
              className={({ isActive }) =>
                `inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-sm font-semibold whitespace-nowrap transition-all ${
                  isActive
                    ? 'bg-slate-100 dark:bg-slate-800 text-slate-950 dark:text-white font-bold shadow-xs'
                    : 'text-slate-600 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-900'
                }`
            ...
            >
              <Store className="w-4 h-4 text-teal-600 dark:text-emerald-400 shrink-0" />
          ...
          <div className="flex lg:hidden items-center space-x-1.5 sm:space-x-2">
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="w-8 h-8 rounded-full flex items-center justify-center text-slate-700 dark:text-slate-200 bg-slate-100/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 active:scale-95 transition-all"
              aria-label="Toggle Theme"
            ...
            <button
              ...
              className="w-8 h-8 rounded-full flex items-center justify-center text-slate-700 dark:text-slate-200 bg-slate-100/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 focus:outline-hidden cursor-pointer active:scale-95 transition-all"
