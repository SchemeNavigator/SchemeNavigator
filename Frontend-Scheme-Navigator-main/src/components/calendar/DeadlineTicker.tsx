  ...
  if (deadline.isOpenYearRound) {
    return (
      <div className="rounded-3xl p-5 sm:p-6 border transition-all relative overflow-hidden bg-gradient-to-br from-emerald-50/90 via-white to-teal-50/50 dark:from-emerald-950/30 dark:via-slate-900 dark:to-slate-900 border-emerald-200 dark:border-emerald-800 shadow-sm">
        ...
        {/* Action Strip: Clean Single "Sync Web" Dropdown */}
        <div className="mt-4 pt-3.5 border-t border-slate-200/60 dark:border-slate-800/80 flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
            ...
            <span>Sync an application reminder with your personal calendar:</span>
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-white dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-750 text-slate-700 dark:text-slate-200 font-bold border border-slate-200 dark:border-slate-700 rounded-xl transition-colors cursor-pointer shadow-2xs"
            >
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 pt-3.5 border-t border-slate-200/60 dark:border-slate-800/80 flex flex-wrap items-center justify-between gap-3 text-xs">
        <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
          <Calendar className="w-3.5 h-3.5 text-teal-600 shrink-0" />
          <span>Sync application reminders directly with your personal calendar:</span>
        </div>
